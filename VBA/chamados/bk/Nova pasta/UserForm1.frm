...
Sub emailSimples()
    ...
    With OutMail
        ...
        .Body = "Data: " & Date & " Hora: " & Time & vbNewLine & _
                ...
                "Equipamento será notebook?" & OptionNotebook & vbNewLine & _
                "CPF: " & tbCpf & vbNewLine & _
                "Acesso à rede: " & CheckBoxRede.Value & vbNewLine & _
                "Usuário Espelho: " & cbRedeEspelhoAD.Value & vbNewLine & _
                ...
                "Usuário Espelho: " & tbEspelhoUAU.Text & vbNewLine & _
                "Acesso Dommus: " & CheckBoxDommus.Value & vbNewLine & _
                "Usuário Espelho: " & tbEspelhoDommus.Text & vbNewLine & _
                "Acesso Construtor Vendas: " & CheckBoxConstrutor.Value & vbNewLine & _
                "Usuário Espelho: " & tbEspelhoConstrutor.Text & vbNewLine
